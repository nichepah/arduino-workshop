...
Stepper::Stepper(uint16_t steps, uint8_t num) {
  MC.enable();
...
void Stepper::step(uint16_t steps, uint8_t dir,  uint8_t style) {
...
uint8_t Stepper::onestep(uint8_t dir, uint8_t style) {
  uint8_t a, b, c, d;
  uint8_t ocrb, ocra;
